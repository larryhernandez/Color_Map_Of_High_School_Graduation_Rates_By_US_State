...
map_econ_dis
```
**Figure 2: The graduation rate for economically disadvantaged students in the U.S. was 76.1% in <br> 2015. Texas boasts the highest graduation rate for this student group at 85.6% which is 3.4 <br> points below the statewide graduation rate (for all students) and 2.4 points above the US National rate.**
...
```
**Figure 3: National graduation rates of the five major racial groups in the US. For reference, <br> the national graduate rate for all students (83.6%) is presented here as an orange, horizontal line.**
...
map_black
```
**Figure 5: The graduation rate for Black students was 74.6% nationally, with the lowest rate <br> occurring in Nevada (55.5%) and the highest in Alabama (87%). The ACGR of Black students was <br> below 70% in 13 states.**
